...
- **CLI tests use scrut**: The `tests/*.md` files are [scrut](https://github.com/facebookincubator/scrut) CLI tests. They are executed in CI via `scrut tests/` after building the binary. Do not flag these as lacking a test runner.
